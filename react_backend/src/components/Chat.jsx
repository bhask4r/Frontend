...
export default function Chat() {
  ...
  return (
    <div className="w-[438px]">
      ...
      <div className="border-2 h-[80px] w-full flex justify-center align-center text-white bg-green-600 align-center">
        <div className="align-center text-[40px]">Ajaffee Va</div></div>
